...
const Calendar = ({
  ...
  const { weekDays: weekDaysList, isRtl, weekStartingIndex } = useLocaleLanguage(locale);
  ...
  const adjustedWeekDaysList = [
    ...weekDaysList.slice(weekStartingIndex),
    ...weekDaysList.slice(0, weekStartingIndex),
  ];
  ...
  const weekdays = adjustedWeekDaysList.map(weekDay => (
